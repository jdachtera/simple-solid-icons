...
export function CodiconEditSession(props) {
  ...
  return (
    <svg
      ...
      fill={merged.fill}
    >
      <path d="M9 1.99902H3V13.999H13V9H14V13.999L13 14.999H3L2 13.999V1.99902L3 0.999023H9V1.99902Z" />
      <path d="M10 11.999H5V10.999H10V11.999Z" />
      <path d="M8 5.99902H9V6.99902H8V9H7V6.99902H5V5.99902H7V4H8V5.99902Z" />
