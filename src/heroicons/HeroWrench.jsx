...
export function HeroWrench({ size = 24, width, height, ...inputProps }) {
...
<path d="M4.86723 19.125H4.87473V19.1325H4.86723V19.125Z" stroke="#0F172A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
}
