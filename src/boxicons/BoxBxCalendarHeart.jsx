...
export function BoxBxCalendarHeart(props) {
  ...
  return (
    <svg
      ...
      fill={merged.fill}
    >
      <path d="M8.648 14.711 11.997 18l3.35-3.289a2.129 2.129 0 0 0 0-3.069 2.225 2.225 0 0 0-3.126 0l-.224.219-.224-.219a2.224 2.224 0 0 0-3.125 0 2.129 2.129 0 0 0 0 3.069z" />
